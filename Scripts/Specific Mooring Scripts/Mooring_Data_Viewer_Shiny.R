...
save_folder <- "C:/Users/gikeda/R/Temp/"
setwd(save_folder)
...
for (variable in variables){
  ...
  ggsave(path = thirtyday_save_directory, paste0(as.character(variable), "_", start, "-", end, "_mooring_review.png"), 
         dpi = 300, height = 8.5, width = 16)
  htmlwidgets::saveWidget(ggplotly(myplots[[count]]), title = paste0(variable), file = paste0(thirtyday_save_directory, "/", as.character(variable), ".html"))
}
...
for (variable in variables){
  ...
  ggsave(path = weekly_save_directory, paste0(as.character(variable), "_", start, "-", end, "_mooring_review.png"), 
         dpi = 300, height = 8.5, width = 16)
  htmlwidgets::saveWidget(ggplotly(myplots[[count]]), title = paste0(variable), file = paste0(weekly_save_directory, "/", as.character(variable), ".html"))
}

#### Shiny App for Comparing Parameters #### 
